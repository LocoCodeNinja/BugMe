...
password NVARCHAR(255) NOT NULL, -- Increase length for storing hashed passwords
role NVARCHAR(20) NOT NULL DEFAULT 'User' -- Decrease length
);
END
GO
...
name NVARCHAR(100) NOT NULL, -- Increase length and change to NVARCHAR
path NVARCHAR(255) NOT NULL, -- Increase length and change to NVARCHAR
price DECIMAL(10,2) NOT NULL,
description_plant NVARCHAR(MAX) NULL, -- Change to NVARCHAR(MAX)
description_care NVARCHAR(MAX) NULL, -- Change to NVARCHAR(MAX)
category NVARCHAR(20) NOT NULL -- Change to NVARCHAR and decrease length
);
END
GO
